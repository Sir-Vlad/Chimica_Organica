...
%	\draw[->] (0,0,0) -- (0,0,2) node[above] {$z$};
	...
	\begin{scope}[canvas is yz plane at x=2]
		\node[rotate=-20] at (0.5,1.8) {\small{Polarizzatore}};
	\end{scope}
	
	\begin{scope}[canvas is yz plane at x=6]
		\node[rotate=-20] at (0.5,1.8) {\small{Analizzatore}};
	\end{scope}
	
	\begin{scope}[canvas is yz plane at x=10]
		\node[rotate=-20,above,yshift=-7pt] at (0.5,1.8) {\small{Schermo di}\\\small{ visualizzazione}};
	\end{scope}
	...
	\begin{pgfonlayer}{layer1}
		...
		\begin{scope}[canvas is xy plane at z=0]
			\draw[latex-] (2,0.6) to[out=160, in=270] (2,3) node[right, yshift=-3pt] {\small{Piano di Polarizazione}\\[-0.5mm]\small{del Polarimetro}};
		\end{scope}
	
		\begin{scope}[canvas is xy plane at z=-0.16]
			\draw[latex-] (5.85,-0.07) to[out=130, in=270] (6,3) node[right, yshift=-3pt] {\small{Piano di Polarizazione}\\[-0.5mm]\small{dell'Analizzatore}};
		\end{scope}
	\end{pgfonlayer}
