...
\begin{reaction}
	...
	\chemmove[green!60!black!70]{
		\draw[shorten <=0pt, shorten >= 1pt] ([xshift=4pt]Nu.north east).. controls +(70:1cm) and +(90:1cm) .. (C);
...
\begin{reaction}
	...
	\chemfig{@{C}C(=[@{Ol}0]@{O}\charge{45=\:,-45=\:}{O})(>:[:120])(<[:240])} \+ \chemfig{@{H}\charge{40:3pt=\chargeColor{+}}{H}}
	\arrow{<=>}[,0.8]
	\chemleft[
	\subscheme{
	\chemfig{C(=[@{Ol}0]@{O1}\charge{80:3pt=\chargeColor{+}}{O}H)(>:[:120])(<[:240])}
	\arrow{<->}[,0.8]
	...
	\chemfig{C(-[0]OH)(-[:120]Nu)(>:[:200])(<[:240])}
	\chemmove[green!60!black!70]{
		\draw[shorten <=3pt, shorten >= 1pt] (O).. controls +(45:.7cm) and +(135:.7cm) .. (H);
		\draw[shorten <=3pt, shorten >= 1pt] (Ol).. controls +(110:.5cm) and +(135:.5cm) .. (O1);
