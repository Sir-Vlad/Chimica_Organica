...
\begin{itemize}
	...
	\item Alogenazione
	      ...
	      % \item Idroborazione
	      %       \begin{reactions}
	      % 	      \AddRxnDesc{Reazione generica di Idroborazione degli alcheni}
	      % 	      \chemfig{C(-[3])(-[5])(=[0]C(-[1])(-[7]))} + \ch{BH3} \arrow \chemfig{-C(-[2])(-[6]H)-C(-[2])(-[6]BH_2)-}
	      %       \end{reactions}
	\item Idrogenazione
	      \begin{reactions}
		      \AddRxnDesc{Reazione generica di Idrogenazione degli alcheni}
...
\subsection{Addizione di acidi alogenidrici}
...
L'addizione di acqua è chiamata \textbf{idratazione}. Generalmente, questa reazione avviene in presenza di catalizzatore acido (\ch{H2SO4} concentrato), l'acqua di addiziona al doppio legame di un alchene per formare un alcol.
...
\subsection{Addizione di Alogeni}
...
\begin{reaction}
	...
	\chemname{\chemfig{[:90]@{ca1}C*3((<[:-55]H)(<:[:-10]CH_3)-[@{lX}]@{X}\charge{90:3pt=\chargeColor{+}}{X}-@{ca2}C(<:[:190]H_3C)(<[:235]H)-)}}{attacco anti} + \chemfig{@{x}\charge{180=\:,45:3pt=\chargeColor{-}}{X}}
	\arrow(--.mid west)
	\chemname{\chemfig{C(<:[3]H_3C)(-[5]Cl)(<[:165]H)(-C(-[1]Cl)(<[7]H)(<:[:-15]CH_3))}}{a} + \chemname{\chemfig{C(<:[:195]H_3C)(-[3]Cl)(<[5]H)(-C(-[7]Cl)(<[:15]H)(<:[1]CH_3))}}{b}
	\chemmove[green!60!black!70]{
...
\begingroup
\begin{reaction}
	\AddRxnDesc{Formazioni di aloidrine}
	\chemfig{C(-[3]CH_3)(-[5]H)(=[@{dl}]C(-[1]CH_3)(-[7]H))} + \chemfig{@{x1}X-[@{lx}]@{x2}X}
	\arrow[,0.8]
	\chemfig{@{c}\charge{45:3pt=\chargeColor{+}}{C}(-[3]CH_3)(-[5]H)(-C(-CH_3)(-[2]@{x}\charge{180=\:}{X})(-[6]H))}
	\arrow(--.base west)[,0.8]
	\chemname{\chemfig{[:90]C*3((<[:-55]H)(<:[:-10]CH_3)-[3]\charge{90:3pt=\chargeColor{+}}{X}-C(<:[:190]H_3C)(<[:235]H)-)}}{Intermedio a\\ponte alonio}
	\arrow{->}[-90]
	\chemname{\chemfig{[:90]@{ca1}C*3((<[:-55]H)(<:[:-10]CH_3)-@{X}\charge{45:3pt=\chargeColor{+}}{X}-[@{lX}]@{ca2}C(<:[:190]H_3C)(<[:235]H)-)}}{attacco anti}
	\arrow(--.mid east){->[\chemfig{H_2@{ox}\charge{0=\:}{O}}]}[-180]
	\chemfig{C(<:[:-120]H_3C)(-[:120]\charge{135=\chargeColor{+}}{O}(-[@{hl}2]@{h}H)(-[4]H))(<[:-165]H)(-C(-[:60]X)(<[:-60]H)(<:[:-15]H))}
	\arrow(.mid west--){->[\ch{-H2}]}[-180]
	\chemfig{C(<:[:-120]H_3C)(-[:120]OH)(<[:-165]H)(-C(-[:60]X)(<[:-60]H)(<:[:-15]H))}
	\chemmove[green!60!black!70]{
		\draw[shorten <=3pt, shorten >= 1pt] (dl).. controls +(90:1.5cm) and +(90:1cm) .. (x1);
		\draw[shorten <=3pt, shorten >= 1pt] (lx).. controls +(90:.8cm) and +(90:.8cm) .. (x2);
		\draw[shorten <=3pt, shorten >= 5pt] (x).. controls +(180:.8cm) and +(90:.8cm) .. (c);
		\draw[shorten <=3pt, shorten >= 1pt] ([xshift=2pt]ox.mid east).. controls +(-90:1.2cm) and +(-90:1.2cm) .. (ca1);
		\draw[shorten <=3pt, shorten >= 1pt] (lX).. controls +(135:.5cm) and +(180:.2cm) .. (X);
		\draw[shorten <=3pt, shorten >= 1pt] (hl).. controls +(180:.5cm) and +(180:.5cm) .. (h);
	}
\end{reaction}
\endgroup
...
\subsection{Riduzione degli alcheni}
