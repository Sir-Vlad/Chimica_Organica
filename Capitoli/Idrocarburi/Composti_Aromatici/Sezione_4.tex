...
\begin{description}
	...
	\item[Stadio 1:] Attacco dell'elettrofilo all'anello aromatico per dare l'intermedio di reazione:
		...
		\begin{reaction*}
			...
			\chemleft[
			\subscheme{
			\chemfig{*6(=[@{d2}]-@{d1c}\charge{-30:3pt=\chargeColor{+}}{}-(-[1]E)(-[0]H)-=-)}
			\arrow{<->}
			...
			\chemmove[green!60!black!70]{
				...
				\draw[shorten <=3pt, shorten >= 3pt] (d2) .. controls +(60:.4cm) and +(135:.5cm) .. (d1c);
				\draw[shorten <=3pt, shorten >= 3pt] (d3) .. controls +(-60:.5cm) and +(15:.5cm) .. (d2c);
			}
		\end{reaction*}}
	\item[Stadio 2:] Trasferimento di un protone ad una base per rigenerare l'anello aromatico:
		{\scriptsize
		\begin{reaction*}
			\chemfig{*6(=-\charge{-20:2pt=\chargeColor{+}}{}-[@{dlc}](-[1]E)(-[@{hl}0]@{h}H)-=-)} \arrow{0}[,0]\+ \chemfig{@{B}\charge{180[circle]=\:}{Base}}
			\arrow{->[veloce]}
			...
			\chemmove[green!60!black!70]{
				...
				\draw[shorten <=1pt, shorten >= 2pt] (hl) .. controls +(290:.3cm) and +(0:.3cm) .. (dlc);
			}
		\end{reaction*}}
\end{description}
...
\begin{description}
	...
	\item[Stadio 2:] \textit{Attacco dell'elettrofilo all'anello}. Lo ione cloronio attacca l'anello formando un carbocatione stabilizzato per risonanza:
		...
		\begin{reaction}
			...
			\chemleft[
			\subscheme{
			\chemfig{*6(=[@{d2}]-@{d1c}\charge{-30:3pt=\chargeColor{+}}{}-(-[1]Cl)(-[0]H)-=-)}
			\arrow{<->}
			...
			\chemmove[green!60!black!70]{
				\draw[shorten <=1pt, shorten >= 1pt] ([xshift=-5pt]d1) .. controls +(270:.7cm) and +(270:.7cm) .. (el);
				\draw[shorten <=3pt, shorten >= 3pt] (d2) .. controls +(60:.5cm) and +(135:.5cm) .. (d1c);
				\draw[shorten <=3pt, shorten >= 3pt] (d3) .. controls +(-60:.5cm) and +(15:.5cm) .. (d2c);
			}
		\end{reaction}}
	\item[Stadio 3:] \textit{Rimozione di un protone}. Il protone viene strappato dal catione intermedio \ch{FeCl4^{-}} e forma \ch{HCl}, rigenerando il catalizzatore e producendo \iupac{clorobenzene}:
		...
		\begin{reaction}
			...
			\chemfig{*6(=-\charge{150:3pt=\chargeColor{+}}{}-[@{dlc}](-[1]Cl)(-[@{hl}0]@{h}H)-=-)}
			\arrow{0}[,0]\+
...
\begin{description}
	...
	\item[Stadio 3:]  \textit{Rimozione di un protone}.
		...
		\begin{reaction}
			...
			\chemfig{*6(=-\charge{150:3pt=\chargeColor{+}}{}-[@{dlc}](-[1]R)(-[@{hl}0]@{h}H)-=-)}
			\arrow{0}[,0]\+
			\chemfig{\charge{45:3pt=\chargeColor{-}}{Fe}(-[0]Cl)(-[2]Cl)(-[@{B}4]\charge{180=\:,90=\:,270=\:}{Cl})(-[6]Cl)}
			\arrow{->[veloce]}
...
\begin{reaction}
	...
	\chemfig{R-C(=[2]O)-@{cl1}Cl} \+ \chemfig{@{al}Al(-[2]Cl)(-[6]Cl)-Cl}
	\arrow{<=>}
	\chemfig{R-C(=[2]O)-[@{cll}]@{cl2}\chemabove{Cl}{\color{red}\scriptstyle\oplus}-\charge{45:3pt=\chargeColor{-}}{Al}(-[2]Cl)(-[6]Cl)-Cl}
	\arrow[-90]
	...
	\chemright]}
	\chemmove[green!60!black!70]{
		\draw[shorten <=3pt, shorten >= 1pt] (cl1).. controls +(270:1cm) and +(225:1cm) .. (al);
		\draw[shorten <=3pt, shorten >= 1pt] (cll).. controls +(-90:.5cm) and +(-90:.5cm) .. (cl2);
	}
\end{reaction}
