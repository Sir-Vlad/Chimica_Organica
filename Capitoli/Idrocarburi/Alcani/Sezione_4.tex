...
Il cicloesano può adottare diverse conformazioni ma solo due sono quelle principali: quella a sedia e quella a barca.
...
\begin{figure}[btp]
	...
	\begin{tabular}{cc}
		\chemfig[cram width=2pt,bond join=true]{?<[:-50]-[:10,,,,line width=2pt]>[:-20]-[:130]-[:190]?} & \chemfig[cram width=2pt,bond join=true]{?<[:-50]-[:0,,,,line width=2pt]>[:50]-[:215,0.9]-[:180,0.8,,,]?} \\
...
Per il cicloesano, le due conformazioni a sedia possono interconvertirsi tra trasformando prima in una barca e quindi nell'altra sedia, come possiamo vedere~\autoref{rct:cicloesano_conf}.
...
\begin{reaction}
	...
	\arrow{0}[,0]
	\chemfig[cram width=2pt,bond join=true]{?<[:-50]-[:10,,,,line width=2pt]>[:-20]-[:130]-[:190]?}
	\arrow{<->}
	\chemfig[cram width=2pt,bond join=true]{?<[:-50]-[:0,,,,line width=2pt]>[:50]-[:215,0.9]-[:180,0.8,,,]?}
	\arrow{<->}
	\chemfig[cram width=2pt,bond join=true]{?-[:-10]-[:20]<[:-130]-[:-190,,,,line width=2pt]>[:200]?}
\end{reaction}
