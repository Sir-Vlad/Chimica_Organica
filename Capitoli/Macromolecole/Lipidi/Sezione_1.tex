...
In genere, un grasso o un olio sono miscele di trigliceridi differenti. Generalmente, i grassi sono composti prevalentemente da trigliceridi saturi e provengono da fonti animali mentre gli oli sono composti prevalentemente da trigliceridi insaturi e provengono da fonti vegetali.
...
\chemnameinit{}
\begin{reaction}
	\AddRxnDesc{Riduzione della trioleina}
	\arrow{0}[,0]
	\chemname{\chemfig{
	[2]CH_2([0]-O-[:30,.6](=[2,.6]O)-[@{op1}:-30,.6]-[:+30,.6]-[@{cl1}:-30,.6]-[:+30,.6]=_[0,.6]-[:-30,.6]-[@{op2}:+30,.6]-[:-30,.6]-[@{cl2}:+30,.6])%
	-[,1.5]CH([0]-O-[:30,.6](=[2,.6]O)-[@{op3}:-30,.6]-[:+30,.6]-[@{cl3}:-30,.6]-[:+30,.6]=_[0,.6]-[:-30,.6]-[@{op4}:+30,.6]-[:-30,.6]-[@{cl4}:+30,.6])%
	-[,1.5]CH_2([0]-O-[:30,.6](=[2,.6]O)-[@{op5}:-30,.6]-[:+30,.6]-[@{cl5}:-30,.6]-[:+30,.6]=_[0,.6]-[:-30,.6]-[@{op6}:+30,.6]-[:-30,.6]-[@{cl6}:+30,.6])}}{\iupac{trioleato di glicerile}\\(\iupac{trioleina})}
...
I trigliceridi quando vengono riscaldati in presenza di sostanze alcaline (come \ch{NaOH}), l'estere si trasforma in glicerolo e nei sali degli acidi grassi. I sali degli acidi grassi a lunga catena sono chiamati \textbf{saponi}.
\chemnameinit{}
{\small
\begin{reaction}
