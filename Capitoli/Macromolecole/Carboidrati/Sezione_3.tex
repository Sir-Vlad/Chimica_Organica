...
\begin{reaction}
	...
	\arrow{->[\chemfig{CH_3C(=[2,,3]O)-CCH_3(=[2]O)}][piridina, \unit{0\celsius}]}[,2]
...
\begin{reaction}
	\AddRxnDesc{Sintesi di Williamson con gli zuccheri}
	\arrow{0}[,0]
	\chemname{\chemfig{O?-[7,1.5](-[2]OH)<[5,1.5](-[6]OH)-[4,1.5,,,line width=4pt,line cap=round](-[2]OH)>[3,1.5](-[6]OH)-[1,1.5]?(-[2]CH_2OH)}}{\iupac{\b-\D-glucopiranosio}}
...
\begin{reaction}
	\AddRxnDesc{Riduzione dei monosaccaridi}
	\arrow{0}[,0]
	\chemname{\chemfig{O?-[7,1.5](-[2]OH)<[5,1.5](-[6]OH)-[4,1.5,,,line width=4pt,line cap=round](-[2]OH)>[3,1.5](-[6]OH)-[1,1.5]?(-[2]CH_2OH)}}{\iupac{\b-\D-glucopiranosio}}
	\arrow
...
\begin{reaction}
	\AddRxnDesc{Ossidazione blanda dei monosaccaridi}
	\arrow{0}[,0]
	\chemname{\glucosio}{\iupac{\D-glucosio}}
...
\begin{reaction}
	\AddRxnDesc{Ossidazione dei monosaccaridi}
	\arrow{0}[,0]
	\chemname{\glucosio}{\iupac{\D-glucosio}}
	\arrow{->[\ch{HNO3}]}[,1.5]
